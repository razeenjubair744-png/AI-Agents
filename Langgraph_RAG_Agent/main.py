...
llm = ChatOpenAI(api_key = openai_api_key ,model_name="gpt-4o-mini", temperature=0)
...
def retriever_tool(query:str)->str:
    """Use this tool to retrieve relevant information from the document based on the user's query."""
